...
class GlobalLogCheckpoint : public LogEntry {
...
public:
    GlobalLogCheckpoint(int16_t lastEntryOffset, uint16_t lastEntryLength, uint32_t crc = 0);
    ...
    EntryType type() const override { return EntryType::GLOBAL_LOG_CHECKPOINT; }
};
